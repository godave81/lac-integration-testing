...
module.exports = (
    ...
    function apiRallyToJiraVerifyBulkUpdatePreliminaryEstimate(jiraUrl, featureName, featureNameCount, jiraStatus) {
        ...
        browser.call(function () {
            return new Promise(function (resolve, reject) {
                ...
                var jiraTimer = setInterval(() => {
                    ...
                    //Reformat Rally Preliminary Estimate Value to Jira Format by Removing text inside Parenthesis
                    jiraStatus = jiraStatus.replace(/\s*\(.*?\)\s*/g, '').trim();

                    var queryString = "?jql=text~" + "\"" + featureName + "\"" + "AND" + "\"" + "Preliminary Estimate" + "\"" + "=" + jiraStatus + "&maxResults=" + featureNameCount + "&validateQuery=true&fields=summary,customfield_11405";
        ...
        }); // end function apiRallyToJiraVerifyBulkUpdatePreliminaryEstimate
