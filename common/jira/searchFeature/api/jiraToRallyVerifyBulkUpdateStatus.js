...
module.exports = (
    ...
    function apiJiraToRallyVerifyBulkUpdateStatus(rallyUrl, featureName, featureNameCount, statusField) {
        ...
        browser.call(function () {
            return new Promise(function (resolve, reject) {
                ...
                var rallyTimer = setInterval(() => {
                    ...
                    let queryString = "?query=((Name = " + "\"" + featureName + "\"" + ")" + " and (State.Name = "+statusField+"))" + "&pagesize=1";
                        ...
                        if (!error && response.statusCode === 200) {
                            ...
                            for (let key in jsonObj) {
                                ...
                                if (TotalResultCount === featureNameCount) {
                                    ...
                                    console.log(`${TotalResultCount} Features Updated to ${statusField} in ${rallyUrl} \n`);
                                    resolve();
